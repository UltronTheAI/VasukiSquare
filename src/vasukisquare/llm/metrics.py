...
class BookGenerationMetrics(BaseModel):
    ...
    def llm_calls_total(self) -> int:
        return self.groq.calls

    @property
    def llm_calls_by_stage(self) -> Dict[str, int]:
        return self.groq.calls_by_stage
    ...
    def summary_string(self) -> str:
        ...
        lines = [
            "Generation Metrics:",
            f"  Groq calls: {self.groq.calls} (Model: {self.groq.model or 'None'})",
